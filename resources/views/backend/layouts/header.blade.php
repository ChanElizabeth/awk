<!-- <header id="header" class="header">
    <div class="top-left">
        <div class="navbar-header">
            <a class="navbar-brand text-dark" href="{{ route('dashboard.index')}}" style="font-family: Oleo Script Swash Caps, cursive;">AwanKita</a>
            <a class="navbar-brand hidden" href="{{ route('dashboard.index')}}" style="font-family: Oleo Script Swash Caps, cursive;">AwanKita</a>
            ...
            <div class="user-area dropdown float-right">
                ...
                <div class="user-menu dropdown-menu">
                    @can('isAdmin', Auth::user())
                        <a class="nav-link" href="{{ route('dashboard.admin.setting.index') }}"><i class="fa fa-cog"></i>App Settings</a>
                    @endcan

                    <a class="nav-link" href="{{ route('dashboard.user.show') }}"><i class="fa fa-user"></i>My Profile</a>
      ...
      <header class= "app-header app-header-dark">
        ...
        <div class="top-bar">
          ...
          <div class="top-bar-brand">
            <!-- toggle aside menu -->
            <button id="sidemenu"class="hamburger hamburger-squeeze mr-2" type="button" data-toggle="aside-menu" aria-label="toggle aside menu"><span class="hamburger-box"><span class="hamburger-inner"></span></span></button> <!-- /toggle aside menu -->
            <a class="navbar-brand text-white" href="{{ route('dashboard.index')}}" style="font-family: Oleo Script Swash Caps, cursive;">AWANKITA</a>
          </div><!-- /.top-bar-brand -->
          <!-- .top-bar-list -->
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
              ...
              <!-- .btn-account -->
                ...
                <div class="dropdown d-none d-md-flex">
                    <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-sm fas fa-user"></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">{{Auth::user()->name}}</span></span></button> 
                    ...
                    @can('isAdmin', Auth::user())
                            <a class="dropdown-item" href="{{ route('dashboard.admin.setting.index') }}"><span class="dropdown-icon fas fa-cog"></span> App Settings</a> 
                        @endcan
